		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="tag"></i> <span class="align-middle">Category</span>
					...
					<li class="sidebar-item ">
						<a class="sidebar-link" href="{{route('addcategory')}}">
              ...
              <i class="align-middle" data-feather="zap"></i> <span class="align-middle">Product</span>
            </a>
					</li>

					<li class="sidebar-item ">
						<a class="sidebar-link" href="{{route('addproduct')}}">
