                ...
                <div class="features-active">
                    <div class="product-item">
                        <div class="product-item-image">
                            <a href="{{route('productdetail')}}"><img src="dist/images/product/05.jpg" alt="Product Name"
                                    class="img-fluid"></a>
                            <div class="cart-icon">
                        ...
                        <div class="product-item-info">
                            <a href="{{route('productdetail')}}">BERRY TYPE-II: C1N Backpack</a>
                            <span>$975</span> <del>$999</del>
                        </div>
                    </div>
                    <div class="product-item">
                        <div class="product-item-image">
                            <a href="{{route('productdetail')}}"> <img src="dist/images/product/04.jpg" alt="Product Name"
                                    class="img-fluid"></a>
                            <div class="cart-icon">
                                <a href="#"><i class="far fa-heart"></i></a>
                                <a href="#">
                    ...
                    <div class="product-item">
                        <div class="product-item-image">
                            <a href="{{route('productdetail')}}"><img src="dist/images/product/01.jpg" alt="Product Name"
                                    class="img-fluid"></a>
                            <div class="cart-icon">
                                <a href="#"><i class="far fa-heart"></i></a>
                                <a href="#">
